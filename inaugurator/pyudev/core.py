...
try:
    ...
    from inaugurator.pyudev._compat import check_output

from inaugurator.pyudev.device import Device
from inaugurator.pyudev._libudev import libudev
from inaugurator.pyudev._util import (ensure_unicode_string, ensure_byte_string,
